...
func (_Nft *NftTransactor) MintNFT(opts *bind.TransactOpts, recipient common.Address, tokenURI string) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "mintNFT", recipient, tokenURI)
}

// MintNFT is a paid mutator transaction binding the contract method 0xeacabe14.
//
// Solidity: function mintNFT(address recipient, string tokenURI) returns(uint256)
func (_Nft *NftSession) MintNFT(recipient common.Address, tokenURI string) (*types.Transaction, error) {
	return _Nft.Contract.MintNFT(&_Nft.TransactOpts, recipient, tokenURI)
}

// MintNFT is a paid mutator transaction binding the contract method 0xeacabe14.
//
// Solidity: function mintNFT(address recipient, string tokenURI) returns(uint256)
func (_Nft *NftTransactorSession) MintNFT(recipient common.Address, tokenURI string) (*types.Transaction, error) {
	return _Nft.Contract.MintNFT(&_Nft.TransactOpts, recipient, tokenURI)
}
